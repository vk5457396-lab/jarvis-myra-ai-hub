...
import { User, Wallet, Users, Copy, LogOut, TrendingUp, Gift, Shield, ExternalLink } from "lucide-react";
...
const Dashboard = () => {
  ...
  const stats = [
    ...
    { icon: TrendingUp, label: "Total Earnings", value: `₹${earnings.reduce((s, e) => s + e.commission_amount, 0)}`, gradient: "from-amber-500 to-orange-500", accentHsl: "38 92% 55%" },
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="mb-10">
            <div className="relative rounded-2xl overflow-hidden">
              ...
              <div className="relative rounded-[calc(1rem-1px)] m-px p-6" style={{ background: "linear-gradient(165deg, hsla(188,100%,50%,0.04) 0%, hsla(220,20%,6%,0.97) 100%)" }}>
                ...
                <p className="text-muted-foreground text-sm mb-4">Share this link and earn <span className="text-emerald-400 font-bold">5% commission</span> on every purchase made by your referrals.</p>
