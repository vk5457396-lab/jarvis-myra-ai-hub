    ...
    <footer className="relative border-t border-white/10 bg-background/50 backdrop-blur-lg">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-display text-sm text-primary mb-4 tracking-wider">QUICK LINKS</h4>
        ...
        <div className="mt-6 pt-6 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-muted-foreground text-sm">© 2026 codeninjavik. All rights reserved.</p>
          <p className="text-muted-foreground text-sm flex items-center gap-1">Made with <Heart size={14} className="text-destructive animate-pulse" /> for the future</p>
        </div>
      </div>
    </footer>
  );
